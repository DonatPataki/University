...
void drawPaRaCube ( int idx )
{
        ...
        glRotatef ( cubeLetters[idx].rotx, 1.5f, 0.0f, 0.0f );
        glRotatef ( cubeLetters[idx].roty, 0.0f, 42.0f, 0.0f );
        glRotatef ( cubeLetters[idx].rotz, 0.0f, 0.0f, 15.0f );

        glBegin ( GL_QUADS );

        glColor3f ( 0.818f, .00f, 0.824f );
...
void draw ( void )
{
        glClearColor ( 1.0f, .50f, 1.0f, 1.0f );
